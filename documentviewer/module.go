...
import (
	...
	"p9e.in/ugcl/documentviewer/config"
	"p9e.in/ugcl/documentviewer/handlers"
	"p9e.in/ugcl/documentviewer/repository"
	"p9e.in/ugcl/documentviewer/services"
	"p9e.in/ugcl/documentviewer/services/interfaces"
	"p9e.in/ugcl/documentviewer/events"
	"p9e.in/ugcl/documentviewer/utils/compression"
	"p9e.in/ugcl/documentviewer/utils/processing"
	"p9e.in/ugcl/documentviewer/utils/watermark"
	"p9e.in/ugcl/documentviewer/utils/security"
)
